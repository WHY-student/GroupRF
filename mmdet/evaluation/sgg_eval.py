...
from .sgg_metrics import SGMeanRecall, SGRecall, SGPairAccuracy
...
def vg_evaluation_single(
    ...
    eval_recall = SGRecall(result_dict, # {}
                           nogc_result_dict, # {}
                           nogc_thres_num, # [56]
                           detection_method=detection_method) # 'pan_seg'
    ...
    global_container['multiple_preds'] = multiple_preds # false
    global_container['num_predicates'] = num_predicates # 57
    global_container['iou_thrs'] = iou_thrs # 0.5
...
def evaluate_relation_of_one_image(groundtruth, prediction, global_container,
    ...
    local_container['pred_rels'] = prediction.rels
    # local_container['gt_boxes'] = groundtruth.bboxes  # (#gt_objs, 4)
    local_container['pred_classes'] = prediction.labels  # (#gt_objs, )
