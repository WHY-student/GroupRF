...
model = dict(
    ...
    train_cfg=dict(
        ...
        freeze_layers = ["panoptic_head", "backbone"],
    ),
    test_cfg=dict(
        panoptic_on=True,
...
optimizer = dict(
    ...
    # paramwise_cfg=dict(
    #     custom_keys={
    #         'panoptic_head': dict(lr_mult=0, decay_mult=1.0)
...
# resume_from = './output/v6_segment_freeze/epoch_3.pth'
resume_from = None
work_dir = './output/v6_segment_freeze'
