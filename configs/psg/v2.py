...
model = dict(
    ...
    relationship_head=dict(
        ...
        pretrained_transformers='/root/autodl-tmp/psg/mfpsg/checkpoints/chinese-roberta-wwm-ext',
        cache_dir='/root/autodl-tmp/psg/mfpsg/output/tmp',
...
data = dict(
    ...
    train=dict(
        ...
        seg_prefix='/root/autodl-tmp/dataset/coco/',
...
resume_from = '/root/autodl-tmp/psg/mfpsg/output/v2/latest.pth'
work_dir = '/root/autodl-tmp/psg/mfpsg/output/v2'
